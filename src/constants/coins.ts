...
export const COIN_TYPE = {
  ...
  [Network.MAINNET]: {
    ...
    V_LP_SUI_WORMHOLE_WBNB: `${
      ...
      MAINNET_BASE_COINS.WORMHOLE_WBNB
    }>`,
    V_LP_SUI_WORMHOLE_WMATIC: `${
      OBJECT_RECORD[Network.MAINNET].DEX_PACKAGE_ID
    }::core::LPCoin<${VOLATILE[Network.MAINNET]}, ${MAINNET_BASE_COINS.SUI}, ${
      MAINNET_BASE_COINS.WORMHOLE_WMATIC
    }>`,
    V_LP_SUI_WORMHOLE_WFTM: `${
      OBJECT_RECORD[Network.MAINNET].DEX_PACKAGE_ID
    }::core::LPCoin<${VOLATILE[Network.MAINNET]}, ${MAINNET_BASE_COINS.SUI}, ${
      MAINNET_BASE_COINS.WORMHOLE_WFTM
    }>`,
    V_LP_SUI_WORMHOLE_CELO: `${
      OBJECT_RECORD[Network.MAINNET].DEX_PACKAGE_ID
    }::core::LPCoin<${VOLATILE[Network.MAINNET]}, ${MAINNET_BASE_COINS.SUI}, ${
      MAINNET_BASE_COINS.WORMHOLE_CELO
    }>`,
    V_LP_SUI_WORMHOLE_WAVAX: `${
      OBJECT_RECORD[Network.MAINNET].DEX_PACKAGE_ID
    }::core::LPCoin<${VOLATILE[Network.MAINNET]}, ${MAINNET_BASE_COINS.SUI}, ${
      MAINNET_BASE_COINS.WORMHOLE_WAVAX
    }>`,
  },
};
